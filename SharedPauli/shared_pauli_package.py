...
from openfermion import expectation, get_sparse_operator as gso
import numpy as np
import time
...
def apply_shared_pauli(H_q, decomposition, N, Ne, state):
    ...
    all_sharable_contained_decomp, all_sharable_no_fixed_decomp = get_overlapping_decomp(
        sharable_paulis_dict, decomposition, pw_grp_idxes_fix)
    ...
    matrix, b = optimize_coeffs_parallel(
        ...
        sharable_only_no_fixed_decomp,
        pw_indices, state, N, decomposition, alpha=0.001)
    print("M, b obtained")
