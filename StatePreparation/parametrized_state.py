...
from UnitaryPreparation.generalized_fermionic_generator import one_body_unitary
from openfermion import FermionOperator, bravyi_kitaev, expectation, get_sparse_operator as gso
import numpy as np
...
if __name__ == "__main__":
    ...
    killer = (cos_theta / sin_theta) * FermionOperator("2^ 0") + (sin_theta / cos_theta) * FermionOperator("0^ 2")
