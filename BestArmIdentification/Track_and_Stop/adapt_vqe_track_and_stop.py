...
if __name__ == "__main__":
    ...
    H_qubit = ferm_to_qubit(h4_hamiltonians)
    ...
    for rot_idx, (i_rot, j_rot, a_rot, b_rot) in enumerate(valid_combinations):
        ...
        grad = compute_gradient_expectation(H_sparse, rotation_gen_sparse, cisd_wavefunction).real
